...
#include "PlayerBallPowerUpSubStateFreeze.generated.h"

/**
 * 
 */
UCLASS()
class COUCHGAME2024_API UPlayerBallPowerUpSubStateFreeze : public UPlayerBallState
{
	GENERATED_BODY()
...
private:
	...
	TArray<APlayerBall*> GetPlayersInFreezeRange() const;
};
