...
#include "PlayerBallStateGrappled.generated.h"


UCLASS(ClassGroup=(Custom), meta=(BlueprintSpawnableComponent))
class COUCHGAME2024_API UPlayerBallStateGrappled : public UPlayerBallState
{
	GENERATED_BODY()

public:
	// Sets default values for this component's properties
	UPlayerBallStateGrappled();
...
private:
	UFUNCTION()
	void OnEndGrappled(float InGrappledValue);
};
